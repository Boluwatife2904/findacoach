...
export default {
  name: "Login",
  setup() {
    const { email, password, error, isLoading, submitForm, resetValidity, handleError } = authentication("login");

    return { email, password, error, isLoading, submitForm, resetValidity, handleError };
  }
};
</script>
